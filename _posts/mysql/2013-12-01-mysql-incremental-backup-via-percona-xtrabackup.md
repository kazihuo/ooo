...
## MySQL incremental backup via percona-xtrabackup ##

`文/温国兵`

## 一 文章回顾 ##

在上一篇文章，我们讲到<a href="https://dbarobin.github.io/mysql/the-usage-of-percona-xtrabackup/" target="_blank">percona-xtrabackup软件的使用</a>，这一篇文章我们讲解percona-xtrabackup实现增量备份及恢复。
